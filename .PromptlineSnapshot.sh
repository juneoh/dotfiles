...
function __promptline {
  ...
  local a_bg="${wrap}48;5;39${end_wrap}"
  local a_sep_fg="${wrap}38;5;39${end_wrap}"
  local b_fg="${wrap}38;5;235${end_wrap}"
  local b_bg="${wrap}48;5;145${end_wrap}"
  local b_sep_fg="${wrap}38;5;145${end_wrap}"
  local c_fg="${wrap}38;5;145${end_wrap}"
  ...
  local y_fg="${wrap}38;5;145${end_wrap}"
